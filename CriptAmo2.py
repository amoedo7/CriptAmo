...
# Logo y título
tk.Label(root, text="CriptAmo", font=("Courier", 20, "bold"), fg="#00FF00", bg="#121212").pack(pady=20)

# Ingreso de clave existente
key_frame = tk.Frame(root, bg="#121212")
key_frame.pack(pady=5)

tk.Label(key_frame, text="🗝️KEY🗝️:", bg="#121212", fg="white", font=("Courier", 12)).pack(side="left")
key_entry = tk.Entry(key_frame, width=60, font=("Courier", 12), bg="#1e1e1e", fg="lime")
key_entry.pack(side="left", padx=5)

status_label = tk.Label(key_frame, text="❔", font=("Courier", 14), bg="#121212", fg="white")
status_label.pack(side="left", padx=5)

mi_key_btn = tk.Button(root, text="🗝️ Mi KEY", command=from_existing_key, bg="#1c1c1c", fg="cyan", font=("Courier", 12), relief="ridge", bd=2)
mi_key_btn.pack(pady=5)

# Botón de acción para generar direcciones
btn = tk.Button(root, text="🎲 Generar Direcciones Nuevas", command=generar, bg="#2c2c2c", fg="lime", font=("Courier", 14), relief="ridge", bd=2)
btn.pack(pady=20)

donate_btn = tk.Button(root, text="❤️ Donar a El3imm", command=mostrar_donaciones, bg="#2c2c2c", fg="gold", font=("Courier", 12), relief="ridge", bd=2)
donate_btn.pack(pady=5)

# Área de salida
text_output = tk.Text(root, width=85, height=15, font=("Courier", 10), bg="#1e1e1e", fg="lime", wrap="none")
